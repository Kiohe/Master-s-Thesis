---
title: "Coarsened Exact Matching (有期雇用をtreatとして)(2019)"
author: "Kyohei Sato"
date: "2024-10-08"
...
model1 <-  
  lm_robust(logwage ~ d_term_fixed*post_treat + d_term_fixed + post_treat, 
            data= df_2019_women_4)

msummary(model1)

model2 <-  
  lm_robust(d_OJT ~ d_term_fixed*post_treat + d_term_fixed + post_treat, 
            data= df_2019_women_4)
...
model3 <-  
  lm_robust(d_OFF_JT ~ d_term_fixed*post_treat + d_term_fixed + post_treat, 
            data= df_2019_women_4)
