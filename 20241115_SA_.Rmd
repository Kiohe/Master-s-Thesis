...
$$
\begin{aligned}
Y_{it} = \alpha_i + \sum_{r \neq -1} \beta_r \mathbb{I} (t =  r) \times Treat_i +  \sum_{r \neq -1} \eta_r \mathbb{I} (t =  r) + \delta Treat_i + \epsilon_{it}
\end{aligned}
$$
...
iplot(list(reg0, reg1), sep = 0.2, ref.line = -1,
      xlab = 'Time to treatment',
      ylab = "proportion of permanent contract",
      main = 'Event study: Staggered treatment')
legend("bottomleft", col = c(1, 2), pch = c(20, 17), 
       legend = c("NO Control", "Sun & Abraham"))
...
iplot(list(reg3, reg4), sep = 0.2, ref.line = -1,
      xlab = 'Time to treatment',
      ylab = "Wage",
      main = 'Event study: Staggered treatment')
legend("bottomleft", col = c(1, 2), pch = c(20, 17), 
